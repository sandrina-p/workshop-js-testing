...
**Test file:** `sinppets/boredAPI.test.js`

### Before you get started...

I want to share one last thing: In the test file there's an imported module `activityStub`. What's a better way to learn what a stub is than to see (and use) one directly.
