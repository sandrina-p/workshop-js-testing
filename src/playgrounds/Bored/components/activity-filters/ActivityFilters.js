...
export default function ActivityFilters({ onChange }) {
  ...
  function handleFieldChange(name, value) {
    console.log('Updating filtersState', name, value, filtersState)
  ...
  function handleFormSubmit(e) {
    e.preventDefault()
    // WIP: For demo purposes, let's not implement the submit here.
  }
    ...
    <form className={Styles.wrapper} onSubmit={handleFormSubmit}>
      ...
      <div className={Styles.group}>
        ...
        >
          ...
          {['education', 'social', 'busywork'].map(type => (
        ...
        />
        <Button type="reset" variant="outline" size="sm" onClick={handleResetClick}>
          Reset
        </Button>
      </div>
      <div></div>
